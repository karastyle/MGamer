// <copyright file="InputItemCreatorView.cs" company="CarlosLab">
...
namespace CarlosLab.UtilityIntelligence.UI
{
    public class InputItemCreatorView : NameTypeItemCreatorView<InputListViewModel, InputItemViewModel>
    {
        ...
        protected override string FormatListItem(Type itemType)
        {
            ...
            Type inputValueType = itemType.GetValueType(typeof(Input<>));
        ...
        protected override int CompareChoices(Type choice1, Type choice2)
        {
            ...
            {
                Type inputValueType1 = choice1.GetValueType(typeof(Input<>));
                if (inputValueType1 == null)
                    return -1;

                Type inputValueType2 = choice2.GetValueType(typeof(Input<>));

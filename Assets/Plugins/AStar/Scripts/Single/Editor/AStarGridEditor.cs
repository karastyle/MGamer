...
public class AStarGridEditor : Editor
{
    ...
    void DrawGridPreview()
    {
        ...
        System.Reflection.FieldInfo gridField = grid.GetType().GetField("grid", 
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        
        if (gridField == null) return;
        
        AStarNode[,] nodes = gridField.GetValue(grid) as AStarNode[,];
    ...
    void HandleMouseInput()
    {
        ...
        if (gridPlane.Raycast(ray, out float enter))
        {
            ...
            AStarNode hitNode = grid.NodeFromWorldPoint(hitPoint);
    ...
    void RegenerateGrid()
    {
        System.Reflection.MethodInfo createGrid = grid.GetType().GetMethod("CreateGrid", 
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        if (createGrid != null)
        {
            createGrid.Invoke(grid, null);
        }
    }
}